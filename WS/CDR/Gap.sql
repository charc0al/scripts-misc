SELECT  CASE_DATA.CASE_KEY CASE_KEY_GAP,
        ...
        TO_DATE(SCY708_BEN_LKUP.GET_BEOP_VALUE('COVG_ORIG_EFF_DATE_GAP',CASE_DATA.CASE_KEY,NULL,NULL,N_RQST_DT_IN,'L'),'YYYY/MM/DD') COVG_ORIG_EFF_DATE_GAP,
        ...
        SCY708_BEN_LKUP.F_GET_FREE_COVER_AMT(CDR_VIEW.CASE_KEY,BEN_TYPES.BNTP_KEY,N_RQST_DT_IN,'N') FREE_COVER_GAP,
        CDR_VIEW.CNTRCT_TYPE_GAP,
        SCY708_BEN_LKUP.F_GET_SCHEME_LVL_BNTP_TYP(BEN_TYPES.BNTP_KEY) TRANSFER_GAP,
        
        CDR_VIEW.SERIES_GAP,
        
        SCY708_BEN_LKUP.F_GET_SLRY_CHG_DT(BEN_TYPES.BNTP_KEY,N_RQST_DT_IN) SLRY_CHNG_DT_GAP, 
        SCY708_BEN_LKUP.GET_CTRB_DESC(RISK_RULE_DETL.FDRT_KEY,N_RQST_DT_IN) CONTRIB_GAP,
        CDR_VIEW.CONTRACT_PART_GAP,
        CDR_VIEW.PARTIC_ARRNGMT_GAP,
        CDR_VIEW.S125_PLAN_GAP,
        CDR_VIEW.S125_TAX_GAP,
        CDR_VIEW.EMP_CNTRB_TYP_GAP,
		CDR_VIEW.CH_MAX_AGE_GAP,
        
        
        SCB_BEN_LKUP.F_GET_COMMISSION_SCALE(CDR_VIEW.CASE_KEY,CDR_VIEW.BNTP_KEY,N_RQST_DT_IN) COMM_SCALE_GAP,
      ...
      WHERE CASE_DATA.CONT_NO = 'N_POLICY_NO_IN'
        ...
        AND (RISK_RULE_DETL.XPIR_DT >= N_RQST_DT_IN OR RISK_RULE_DETL.XPIR_DT IS NULL)
        AND RISK_BEN_TRNCH.EFF_DT <= N_RQST_DT_IN
        AND (RISK_BEN_TRNCH.XPIR_DT >= N_RQST_DT_IN OR RISK_BEN_TRNCH.XPIR_DT IS NULL)
        ...
        AND (ENH_ELIG_RTRNCH_ISS.XPIR_DT >= N_RQST_DT_IN OR ENH_ELIG_RTRNCH_ISS.XPIR_DT IS NULL)
        AND ENH_ELIG_RTRNCH_FUT.EFF_DT <= N_RQST_DT_IN
        AND (ENH_ELIG_RTRNCH_FUT.XPIR_DT >= N_RQST_DT_IN OR ENH_ELIG_RTRNCH_FUT.XPIR_DT IS NULL)
